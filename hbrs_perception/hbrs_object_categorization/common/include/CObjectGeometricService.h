...
#include <CRTPNeuralNetworkEnsemble.h>
...
public:
	...
	int getNumCategories(){return this->numberCategories;}
	int getNumNeuronsASPSMatrix(std::string filename);
	std::map<int, CObjectDecomposition> getObjectDecompositon(){ return objectDecompositon;}
	SObjectDescription getLastObjectDecomposition(){ return this->objectDescription;}
	void clearObjectDecomposition(){ objectDecompositon.clear();}
