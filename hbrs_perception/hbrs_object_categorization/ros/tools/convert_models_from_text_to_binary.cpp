...
#include <ProbNeuralNetwork/CRTPNeuralNetworkEnsemble.h>
#include <fstream>
#include <iostream>
...
int main(int argc, char **argv)
{
    ...
    try
	{
        ...
        model_filename = "./data/objectDecompostion//objDecomp_objDecomp.od";
        ...
        model_filename = "./data/rtpnnEnsemble/rtpnn_ensemble.rtp";
