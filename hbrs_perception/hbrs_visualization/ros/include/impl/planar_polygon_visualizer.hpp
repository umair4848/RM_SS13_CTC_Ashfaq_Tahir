...
void PlanarPolygonVisualizer::publish(const pcl16::PlanarPolygon<PointT>& polygon, const std::string& frame_id)
{
...
template<typename PointT>
void PlanarPolygonVisualizer::buildPolygonMarker(const typename pcl16::PointCloud<PointT>::VectorType& points, visualization_msgs::Marker& marker, const std::string& frame_id, int id)
{
