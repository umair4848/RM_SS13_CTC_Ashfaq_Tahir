...
#define  CRPG_MODE_UPTO 2
  ...
  public:    
    ...
    ComplexRadialPolynomialGenerator(int nOrders, 
				     bool forPatternRecognition= false);
    ComplexRadialPolynomialGenerator(int* orders, int nOrders, 
				     bool forPatternRecognition= false);
    ComplexRadialPolynomialGenerator(int n, int m, 
				     bool forPatternRecognition= false);
