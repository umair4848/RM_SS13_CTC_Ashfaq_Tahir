...
void inline strokeStatisticsMainHelper (bool& inStrokeRun, int& inStrokeRunWidth, int& nStrokes,
					list<int>& strokeWidths, int& sumStrokeWidths, CvScalar& pixel);
...
void inline strokeStatisticsLastHelper(ccRelatedData* ccd, int& nStrokes, int& sumStrokeWidths, 
				       list<int>& strokeWidths, double* result);
